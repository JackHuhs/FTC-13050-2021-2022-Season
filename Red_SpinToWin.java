...
public class Red_SpinToWin extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException{
        ...
        driveForward((int)(1738),(int)(900)); //forward 39 inches
        
        turn((int)(90),(int)(900));//turn right 90 degrees
        
        driveForward((int)(100),(int)(900));//forward 12 inches
        
        //PLACE STARTING BOX ON FOUNTAIN THING
         
        driveForward((int)(-1200),(int)(900));
